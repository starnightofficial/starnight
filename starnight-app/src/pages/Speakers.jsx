...
const speakers = [
  {
    ...
    title:'多分野の受講が直ちに教養獲得とはならない',
    summary: '様々な個別知が分散的に存在する知識空間の間（ま）にこそ知性は存在し、それは知の全体を求めてこそ身体化されうる。結局のところ、教養とは知を求める構えに他ならない。そもそも参照軸としての自己がなければ新たな知との距離感も測れず、ただただ「おもしろいか、おもしろくないか」、「役に立ったか、役に立たなかったか」といった表層的感覚でしか承認されない（これではテレビ番組のザッピングとかわらない）。本講義では「学びの学び」と題し、学ぶとは何かについて思考を深める。故に、この講義はその後の大学４年間に影響を及ぼすのは間違いない。',
    message: '学問とは、問いに学ぶこと（「問い学ぶ」ではない）。答えよりも問いを求めて。',
    img: 'speakers/miyano.png',
  },
  {
    name: '高橋 淳先生',
